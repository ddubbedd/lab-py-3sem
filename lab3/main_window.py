...
from PyQt6.QtWidgets import QApplication, QMainWindow, QPushButton, QMessageBox, QFileDialog, QWidget
...
class Window2(object):
    ...
    def retranslate(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Лабораторная №3"))
        self.label.setText(_translate("MainWindow", "Поиск данных"))
        self.pushButton_5.setText(_translate("MainWindow", "Из основного\n"
                                                           "файла"))
        self.pushButton_2.setText(_translate("MainWindow", "По двум \n"
                                                           "файлам"))
        self.pushButton_3.setText(_translate("MainWindow", "По годам"))
        self.pushButton_4.setText(_translate("MainWindow", "По неделям"))
